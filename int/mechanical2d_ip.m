function [Vel Pressure] = mechanical2d_ip(ELEM2NODE, Phases, GCOORD, Mu_ip, Rho, G, Bc_ind, Bc_val, nip, reorder, method)
...
div_max_uz  = 1e-25; div_max     = realmax;
